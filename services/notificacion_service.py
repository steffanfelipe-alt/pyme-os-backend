...
def job_resumen_semanal_email() -> None:
    ...
    try:
        ...
        # Enviar resumen a todos los dueños de todos los studios activos
        from models.studio import Studio
        studios = db.query(Studio).all()
        ...
        for studio in studios:
            # Buscar dueño del studio actual
            ...
            # Vencimientos de la semana del studio
            vencimientos_semana = (
                db.query(Vencimiento, Cliente)
                .join(Cliente, Vencimiento.cliente_id == Cliente.id)
                .filter(
