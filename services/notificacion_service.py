    ...
    try:
        ...
        for studio in studios:
            ...
            if not dueno or not dueno.email:
                logger.warning("Job resumen semanal — studio %d sin dueño con email", studio.id)
                continue

            # Vencimientos de la semana de ESTE estudio
            vencimientos_semana = (
                db.query(Vencimiento, Cliente)
                .join(Cliente, Vencimiento.cliente_id == Cliente.id)
                .filter(
            ...
            # Alertas activas de ESTE estudio
            ...
            # Clientes activos de ESTE estudio
            ...
            try:
                ...
                logger.error("Job resumen semanal — error enviando email a studio %d: %s", studio.id, e)
